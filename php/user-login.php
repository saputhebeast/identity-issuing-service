...
<body>
	<div class = "login-form">
		<section class = "first-row">
			...
			<form name = "login-form" action = "./user-login-check.php" onsubmit = "return validateForm();" method = "POST">
		...
		<section class = "second-row">
			...
			<a class = "main-page-links" href = "./user-login-forgot-password.php">Forgot Password</a>
		</section>
		
		<section class = "third-row">
			<p>Don't have an account? <a class = "main-page-links" href = "./user-sign-up.php">Sign Up</a> here!</p>
		</section>
